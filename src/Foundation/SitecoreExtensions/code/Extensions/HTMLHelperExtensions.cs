namespace Sitecore.Foundation.SitecoreExtensions.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        /// <summary>
        /// Utilizing ImageResizer to crop image with expected dimension.
        /// </summary>
        /// <param name="htmlHelper">MVC HTML Helper.</param>
        /// <param name="imageSrc">The image URL.</param>
        /// <param name="width">The target width.</param>
        /// <param name="height">The target height.</param>
        /// <param name="allowStretch">Allow streth mode.</param>
        /// <param name="allowCrop">All crop mode.</param>
        /// <param name="protectAssetUrl">Enable hash tag.</param>
        /// <returns></returns>
        public static string GetHashedImageUrl(this HtmlHelper htmlHelper, string imageSrc, int width, int height, bool allowStretch = false, bool allowCrop = true, bool protectAssetUrl = true)
        {
            ...
            var mode = allowCrop ? "&mode=crop" : allowStretch ? "&mode=stretch" : "";

            var imageUrl = $"{imageSrc}?ImageResizing=true&w={width}&h={height}{mode}";
